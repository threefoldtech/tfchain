...
use mainnet::runtime_types::sp_core::bounded::bounded_vec::BoundedVec;
...
pub async fn create_twin(
    ...
    let create_twin_tx = mainnet::tx().tfgrid_module().create_twin(ip);
...
pub async fn update_twin(
    ...
    let update_twin_tx = mainnet::tx().tfgrid_module().update_twin(ip);
...
pub async fn get_twin_by_id(
    ...
    Ok(cl
        ...
        .at_latest()
        .await?
        .fetch(&mainnet::storage().tfgrid_module().twins(id))
        .await?
        .map(types::Twin::from))
}
...
pub async fn get_contract_by_id(
    ...
    Ok(cl
        ...
        .at_latest()
        .await?
        .fetch(&mainnet::storage().smart_contract_module().contracts(id))
        .await?
...
pub async fn get_node_by_id(
    ...
    Ok(cl
        ...
        .at_latest()
        .await?
        .fetch(&mainnet::storage().tfgrid_module().nodes(id))
        .await?
...
pub async fn get_farm_by_id(
    ...
    Ok(cl
        ...
        .at_latest()
        .await?
        .fetch(&mainnet::storage().tfgrid_module().farms(id))
        .await?
