...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn add_reports() -> Weight {
        Weight::from_ref_time(832_738_000).saturating_add(T::DbWeight::get().reads_writes(7, 1))
    }
}
...
impl WeightInfo for () {
    ...
    fn add_reports() -> Weight {
        Weight::from_ref_time(832_738_000).saturating_add(RocksDbWeight::get().reads_writes(7, 1))
    }
}
