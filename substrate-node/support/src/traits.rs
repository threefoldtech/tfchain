...
pub trait ChangeNode<Loc, PubConf, If> {
    fn node_changed(
        node: Option<&super::types::Node<Loc, PubConf, If>>,
        new_node: &super::types::Node<Loc, PubConf, If>,
    );
    fn node_deleted(node: &super::types::Node<Loc, PubConf, If>);
}
