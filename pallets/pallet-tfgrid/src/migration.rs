...
fn migration_unit_to_types_unit(unit: migration::Unit) -> types::Unit {
    match unit {
        migration::Unit::Bytes => types::Unit::Bytes,
        migration::Unit::Kilobytes => types::Unit::Kilobytes,
        migration::Unit::Megabytes => types::Unit::Megabytes,
        migration::Unit::Gigabytes => types::Unit::Gigabytes,
        migration::Unit::Terrabytes => types::Unit::Terrabytes,
    }
}